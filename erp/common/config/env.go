...
func InitEnv() (*Env, zerolog.Logger) {
	...
	viper.BindEnv("ERP_URL")

	viper.BindEnv("ODOO_USER")
	viper.BindEnv("ODOO_PASSWORD")
	viper.BindEnv("ODOO_DB")
